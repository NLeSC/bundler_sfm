...
class SIFT
{
  ...
  public:
    ...
    void writeKeypointsToStdout ( const KeyList& keys );

    /** Outputs image data into a PGM file.
     *  @param[in] szOutputFile  output text file
     *  @param[in] image  the image to write */
    void writeImage ( const char* szOutputFile, const Image& image );
